  ...
  <div class="window">
    <div class="head">
      ...
      <div class="tabs-group">
        ...
        <div key="add-button" class="add-button"></div>
      </div>
    </div>
    <div class="menu">
      <div class="buttons">
    ...
    <div class="content" style=" padding: 20px;">
      <div style="display: flex; align-items: flex-start; justify-content: center; padding-bottom: 20px;">
        <img
            :src="mapStore.detailState.firstimage"
            :alt="mapStore.detailState.title"
        ...
        <div style="margin-left: 20px; max-width: 60%; ">
          <strong style="font-size: 1.2rem; color: #333;">{{ mapStore.detailState.title }}</strong><br/>
          <span style="font-size: 0.9rem; color: #666;">{{ mapStore.detailState.addr1 }}</span>
        </div>
      </div>
